...
We will use TensorFlow Recommenders and content based filtering / collaberative filtering to build a recommendation system for NFTs.  We will use the blockchain to obtain user profiles and use this data to train our model.
